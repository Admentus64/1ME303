...
package object.obstacle {   // Start Package
	...
	// Project Imports
	import asset.obstacle.RainCloudClip;
	import manager.ObstacleManager;
	import object.Entity;
	
	
	
	public class RainCloud extends Obstacle {   // Start Class: RainCloud
		...
		public function RainCloud(manager:ObstacleManager) 			{ super(manager, new RainCloudClip, scale, 1); }	// Constructor: RainCloud
