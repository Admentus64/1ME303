package se.lnu.stickossdk.component.screenkeyboard
{
	...
	public class ScreenKeyboardKeys extends Sprite {
		...
		private function handleInput():ScreenKeyboardKeyCommand {
			if (Input.keyboard.justPressed(_controls.PLAYER_UP) || (Input.gamepads.stickLeftJustUp)) return new ScreenKeyboardKeyUpCommand();
			if (Input.keyboard.justPressed(_controls.PLAYER_DOWN) || (Input.gamepads.stickLeftJustDown)) return new ScreenKeyboardKeyDownCommand();
			if (Input.keyboard.justPressed(_controls.PLAYER_RIGHT) || (Input.gamepads.stickLeftJustRight)) return new ScreenKeyboardKeyRightCommand();
			if (Input.keyboard.justPressed(_controls.PLAYER_LEFT) || (Input.gamepads.stickLeftJustLeft)) return new ScreenKeyboardKeyLeftCommand();
		...
		private function updateInput():void {
			if (Input.keyboard.justPressed(_controls.PLAYER_BUTTON_1) || Input.gamepads.justPressed(10)) {
				_soundSelect.play();
